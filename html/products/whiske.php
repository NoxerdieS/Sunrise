  ...
  <body>
    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="56">
            <div class="product__image" style="background-image: url('../../img/whiske_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">whiske</p>
                <div class="product__specs__info">
                    <div class="product__specs__text">
                      <ul>
                                              <li><b>testowy:</b> testowy123</li>
                                            </ul>
                    </div>
        ...
        <div class="product__bottomSection">
          ...
          <img src="../../img/whiske_img.png" alt="">
