  ...
  <body>
    ...
    ?>
      ...
      <div class="product__topSection">
        <input type="hidden" id="productId" value="74">
        <div class="product__image" style="background-image: url('../../img/Piwo_img.png');">
        </div>
        <div class="product__specs">
          <p id="productName" class="product__specs--headline">Piwo</p>
          <div class="product__specs__info">
            ...
            <div class="product__specs__price">
              <p class="product__specs__price--price">5 zł</p>
              <div class="number">
