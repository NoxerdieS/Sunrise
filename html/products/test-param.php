    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="32">
            <div class="product__image" style="background-image: url('../../img/test param_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">test param</p>
                <div class="product__specs__info">
                    <div class="product__specs__text">
                      <ul>
                                              <li><b>test:</b> test1</li>
                                            </ul>
                    </div>
        ...
        <div class="product__bottomSection">
          ...
          <img src="../../img/test param_img.png" alt="">
          <table class="product__bottomSection--table">
                      <tr>
              <td class="table-headline">test</td>
              <td>test1</td>
            </tr>
                    </table>
    </main>
