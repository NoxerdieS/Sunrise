    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="67">
            <div class="product__image" style="background-image: url('../../img/saSA_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">saSA</p>
                <div class="product__specs__info">
                    ...
                    <div class="product__specs__price">
                      <p class="product__specs__price--price">21 zł</p>
                      <div class="number">
