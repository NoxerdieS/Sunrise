  ...
  <body>
    ...
    ?>
      ...
      <div class="product__topSection">
        <input type="hidden" id="productId" value="72">
        <div class="product__image" style="background-image: url('../../img/dsad_img.png');">
        </div>
        <div class="product__specs">
          <p id="productName" class="product__specs--headline">dsad</p>
          <div class="product__specs__info">
            <div class="product__specs__text">
              <ul>
                                  <li><b>Moc:</b> 40%</li>
                                  <li><b>Pochodzenie:</b> liberia</li>
                              </ul>
            </div>
            <div class="product__specs__price">
              <p class="product__specs__price--price">321 zł</p>
              <div class="number">
