  ...
  <body>
    ...
    ?>
      ...
      <div class="product__topSection">
        ...
        <div class="product__image" style="background-image: url('../../img/Singleton_img.png');">
        </div>
        <div class="product__specs">
          <p id="productName" class="product__specs--headline">Singleton</p>
          <div class="product__specs__info">
            ...
            <div class="product__specs__price">
              <p class="product__specs__price--price">200 zł</p>
              <div class="number">
      ...
      <div class="product__bottomSection">
        ...
        <img src="../../img/Singleton_img.png" alt="">
