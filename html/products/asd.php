  ...
  <body>
    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="60">
            <div class="product__image" style="background-image: url('../../img/asd_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">asd</p>
                <div class="product__specs__info">
                    ...
                    <div class="product__specs__price">
                      <p class="product__specs__price--price">213 zł</p>
                      <div class="number">
        ...
        <div class="product__bottomSection">
          ...
          <img src="../../img/asd_img.png" alt="">
          <table class="product__bottomSection--table">
                      <tr>
              <td class="table-headline">niga</td>
              <td>123</td>
            </tr>
                    </table>
    </main>
