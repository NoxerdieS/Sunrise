    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="68">
            <div class="product__image" style="background-image: url('../../img/dsa_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">dsa</p>
        ...
        <div class="product__bottomSection">
          ...
          <img src="../../img/dsa_img.png" alt="">
          <table class="product__bottomSection--table">
                      <tr>
              <td class="table-headline">dsa</td>
              <td>dsa</td>
            </tr>
                    </table>
    </main>
