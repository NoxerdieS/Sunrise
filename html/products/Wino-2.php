  ...
  <body>
    ...
    ?>
      ...
      <div class="product__topSection">
        <input type="hidden" id="productId" value="73">
        <div class="product__image" style="background-image: url('../../img/Wino 2_img.png');">
        </div>
        <div class="product__specs">
          <p id="productName" class="product__specs--headline">Wino 2</p>
          <div class="product__specs__info">
            ...
            <div class="product__specs__price">
              <p class="product__specs__price--price">231 zł</p>
              <div class="number">
      ...
      <div class="product__bottomSection">
        ...
        <img src="../../img/Wino 2_img.png" alt="">
