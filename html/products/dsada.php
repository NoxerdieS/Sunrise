  ...
  <body>
    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="66">
            <div class="product__image" style="background-image: url('../../img/dsada_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">dsada</p>
