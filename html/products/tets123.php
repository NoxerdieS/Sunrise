  ...
  <body>
    ...
    ?>
      ...
      <div class="product__topSection">
        ...
        <div class="product__image" style="background-image: url('../../img/tets123_img.png');">
        </div>
        <div class="product__specs">
          <p id="productName" class="product__specs--headline">tets123</p>
          <div class="product__specs__info">
            <div class="product__specs__text">
              <ul>
                                  <li><b>parametr 1:</b> wartosc 1</li>
                              </ul>
            </div>
            <div class="product__specs__price">
              <p class="product__specs__price--price">100 zł</p>
              <div class="number">
      ...
      <div class="product__bottomSection">
        ...
        <div class="product__bottomSection--text">
          ...
          <p>testowy opis produktu</p>
        </div>
        <img src="../../img/tets123_img.png" alt="">
        <table class="product__bottomSection--table">
                      <tr>
              <td class="table-headline">parametr 1</td>
              <td>wartosc 1</td>
            </tr>
                  </table>
    </main>
