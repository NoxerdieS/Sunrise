  ...
  <body>
    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="57">
            <div class="product__image" style="background-image: url('../../img/test15_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">test15</p>
                <div class="product__specs__info">
                    <div class="product__specs__text">
                      <ul>
                                              <li><b>testowy:</b> test09</li>
                                            </ul>
                    </div>
        ...
        <div class="product__bottomSection">
          ...
          <img src="../../img/test15_img.png" alt="">
