  ...
  <body>
    ...
    ?>
        ...
        <div class="product__topSection">
          <input type="hidden" id="productId" value="61">
            <div class="product__image" style="background-image: url('../../img/sda_img.png');">
            </div>
            <div class="product__specs">
                <p id="productName" class="product__specs--headline">sda</p>
